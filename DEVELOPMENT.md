...
2. With your terminal of chioce and working directory, run `git clone https://github.com/aksdhama0067/tearscope.git`
...
Follow the instructions for `https://github.com/aksdhama0067/opencv-template`. You can check if your installation works by running the examples in this template repository.
...
## Running TearScope with Qt Creator (Windows)

1. Open `tearscope.pro` set config to MinGW 8.1.0 64 Bit, Build Config to Release.

2. With your terminal of chioce, go to the release directory of the application in my case `C:\git\tearscope\build-tearscope-Desktop_Qt_5_15_2_MinGW_64_bit-Release\release`
...
windeployqt.exe --qmldir ..\..\tearscope .
```

3. Running after compiling from Qt Creator should work. You can find the built binaries in `tearscope_root\build-tearscope-Desktop_Qt_5_15_2_MinGW_64_bit-Release\release`
